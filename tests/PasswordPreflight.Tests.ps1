...
Describe 'PasswordPreflightBehavior' {
    ...
    $cases = @(
        ...
        'probe_cmd_bsp0',
        'probe_cmd_utf8',
        'probe_content_encrypted_plus_need_password',
        'probe_content_encrypted_stage',
        'probe_encrypted_minus_ok',
        'resolve_skips_non_password_ok_probe',
        'resolve_no_tests_for_plain_probe',
        'resolve_content_encrypted_correct_password_ok',
        'resolve_content_encrypted_sets_password_used',
        'resolve_content_encrypted_wrong_password_colon',
        'test_classifies_ok',
        'test_stage_name',
